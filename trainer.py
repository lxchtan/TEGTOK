...
from utils.auxiliary import set_seed, average_distributed_scalar, count_parameters
...
def main():
  ...
  parser.add_argument("--model_checkpoint", type=str, default="roberta-base", help="Path, url or short name of the model")
  parser.add_argument("--abs_path", action='store_true')
  ...
  parser.add_argument("--change_init_way", action='store_true') 
  ...
  if hasattr(args, "decoder_model_name_or_path"):
    model = model_class.from_encoder_decoder_pretrained(
            ...
            knowledge_encoder_pretrained_model_name_or_path=args.knowledge_encoder_model_name_or_path, 
